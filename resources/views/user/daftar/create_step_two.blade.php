        ...
        <div class="block-content block-content-full space-y-3">
            ...
            <div class="row">
                ...
                <div class="block block-rounded">
                    ...
                    <form action="{{ url('pasien-daftar/post-step-two') }}" method="POST">
                        @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row mb-4">
                        ...
                        <div class="col-lg-12 col-xl-12">
                            <div class="mb-4">
                                ...
                                <select class="js-select2 form-select" id="val-select2" name="jkl_pasien" required style="width: 100%;" data-placeholder="Choose one.." required>
                                    <option hidden value="{{ $reqnik->jkl_pasien ?? ''}}">{{ $reqnik->jkl_pasien ?? ''}}</option>
                        ...
                        <div class="mb-4">
                        <a href="{{ url('pasien-daftar/create-step-one') }}" class="btn btn-danger pull-right">
