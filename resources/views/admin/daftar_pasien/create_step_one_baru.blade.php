...
@section('content')   
    ...
    <div class="block block-rounded">
        ...
        <div class="block-content block-content-full space-y-3">
            ...
            <div class="row">
                <form class="js-validation" action="{{ url('pendaftaran-pasien/Post-step-one-baru')}}" method="POST">
                    @csrf
                                ...
                                <div class="row items-push">
                                    <div class="col-lg-10 col-xl-10">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="date" class="js-flatpickr form-control" id="example-flatpickr-custom" name="tgl_lahir" value="{{ $data->tgl_lahir ?? '' }}" required>
                                        </div>
