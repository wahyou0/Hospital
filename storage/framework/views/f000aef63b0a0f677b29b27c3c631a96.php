    ...
    <div class="block block-themed block-rounded">
        ...
        <div class="block-content block-content-full">
            <div class="table-responsive">
                <a href="<?php echo e(url('kamar-rawat/create')); ?>" class="btn btn-alt-success"><i class="far fa-square-plus"></i> Tambah</a>
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Hospital\resources\views/admin/kamar_rawat/index.blade.php ENDPATH**/ ?>