          ...
          <div class="hero-static content content-full px-1">
            <div class="row mx-0 justify-content-center">
              <div class="col-lg-8 col-xl-6">
                ...
                <form class="js-validation-signup" action="<?php echo e(url('register/create')); ?>" method="POST" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="signup-username" name="username" value="<?php echo e(old('username')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="signup-password" name="password">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="block-content block-content-full bg-body-light d-flex justify-content-between">
                      <a class="fs-sm fw-medium link-fx text-muted me-2 mb-1 d-inline-block" href="<?php echo e(url('login')); ?>">
    ...
    <!-- Page JS Code -->
    <script src="<?php echo e(asset('code/assets/js/pages/op_auth_signup.min.js')); ?>"></script>
  </body>
</html><?php /**PATH C:\xampp\htdocs\Hospital\resources\views/register.blade.php ENDPATH**/ ?>