                                ...
                                <div class="row items-push">
                                    <div class="col-lg-10 col-xl-10">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" name="nama_pasien" value="<?php echo e($data->nama_pasien ?? ''); ?>" required>
                                        </div>
                                        <div class="mb-4">
                                            <label class="form-label">Tempat Lahir<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="tempat_lahir" value="<?php echo e($data->tempat_lahir ?? ''); ?>" required>
                                        </div>
                                        <div class="mb-4">
                                            <label class="form-label">Tanggal Lahir <span class="text-danger">*</span></label>
                                            <input type="date" class="js-flatpickr form-control" id="example-flatpickr-custom" name="tgl_lahir" value="<?php echo e($data->tgl_lahir ?? ''); ?>" required>
                                        </div>
